...
import { getdrawPieChart, getdrawPieChart1, getdrawLineChart } from "../../api/api";
export default {
  data() {
    return {
      chartLine: null,
            ...
            series: [
              {
                ...
                radius: "55%",
                data: [
                  { value: value[0], name: "主驾" },
                  { value: value[1], name: "副驾" },
                  { value: value[2], name: "右后" },
                  { value: value[3], name: "左后" }
                ],
                itemStyle: {
                  emphasis: {
                    shadowBlur: 10,
