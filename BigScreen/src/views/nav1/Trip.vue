<template>
	<section>
		...
		<!--列表-->
		<el-table :data="RList" height="650" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			<el-table-column type="selection" width="55">
			</el-table-column>
			<el-table-column type="index" width="60">
			</el-table-column>
			<el-table-column prop="vin" label="vin号" width="200">
			</el-table-column>
      <el-table-column prop="tid" label="时间" width="200" sortable>
			</el-table-column>
      <el-table-column prop="VehTotDistance" label="总里程" width="200">
			</el-table-column>
			<el-table-column prop="tripId" label="行程id" width="120">
			</el-table-column>
...
import {getTripPage, removeUser, batchRemoveUser} from "../../api/api";
...
export default {
  ...
  methods: {
    ...
    getUsers() {
      ...
      //NProgress.start();
      getTripPage(para).then(res => {
        this.total = res.data.total;
        this.page_size = res.data.page_size;
        this.RList = res.data.infos;
